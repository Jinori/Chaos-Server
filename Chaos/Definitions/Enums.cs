...
public enum JewelcraftingCategories : ulong
{
    None = 0,
    BasicRings = 1L,
    ApprenticeRings = 1L << 2,
    JourneymanRings = 1L << 3,
    AdeptRings = 1L << 4,
    BasicNecklaces = 1L << 5,
    ApprenticeNecklaces = 1L << 6,
    JourneymanNecklaces = 1L << 7,
    AdeptNecklaces = 1L << 8,
    BasicEarrings = 1L << 9,
    ApprenticeEarrings = 1L << 10,
    JourneymanEarrings = 1L << 11,
    AdeptEarrings = 1L << 12,
}
...
public enum JewelcraftingRecipes : ulong
{
    ...
    BronzeBerylNecklace = 1 << 21,
    BronzeRubyNecklace = 1 << 22,
    BronzeSapphireNecklace = 1 << 23,
    BronzeEmeraldNecklace = 1 << 24,
    IronBerylNecklace = 1 << 25,
    IronRubyNecklace = 1 << 26,
    IronSapphireNecklace = 1 << 27,
    IronEmeraldNecklace = 1 << 28,
    MythrilBerylNecklace = 1 << 29,
    MythrilRubyNecklace = 1 << 30,
    MythrilSapphireNecklace = 1L << 31,
    MythrilEmeraldNecklace = 1L << 32,
    HybrasylBerylNecklace = 1L << 33,
    HybrasylRubyNecklace = 1L << 34,
    HybrasylSapphireNecklace = 1L << 35,
    HybrasylEmeraldNecklace = 1L << 36,
    BronzeBerylEarring = 1L << 37,
    BronzeRubyEarring = 1L << 38,
    BronzeSapphireEarring = 1L << 39,
    BronzeEmeraldEarring = 1L << 40,
    BronzeHeartstoneEarring = 1L << 41,
    IronBerylEarring = 1L << 42,
    IronRubyEarring = 1L << 43,
    IronSapphireEarring = 1L << 44,
    IronEmeraldEarring = 1L << 45,
    IronHeartstoneEarring = 1L << 46,
    MythrilBerylEarring = 1L << 47,
    MythrilRubyEarring = 1L << 48,
    MythrilSapphireEarring = 1L << 49,
    MythrilEmeraldEarring = 1L << 50,
    MythrilHeartstoneEarring = 1L << 51,
    HybrasylBerylEarring = 1L << 52,
    HybrasylRubyEarring = 1L << 53,
    HybrasylSapphireEarring = 1L << 54,
    HybrasylEmeraldEarring = 1L << 55,
    HybrasylHeartstoneEarring = 1L << 56,
