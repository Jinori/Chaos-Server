...
public enum ArmorsmithingRecipes : ulong
{
    ...
    JeweledSeaBelt = 1L << 26,
    JeweledFireBelt = 1L << 27,
    JeweledWindBelt = 1L << 28,
    JeweledEarthBelt = 1L << 29,
    JeweledNatureBelt = 1L << 30,
    JeweledMetalBelt = 1L << 31,
    JeweledDarkBelt = 1L << 32,
    JeweledLightBelt = 1L << 33,
    EarthBelt = 1L << 34,
    SeaBelt = 1L << 35,
    FireBelt = 1L << 36,
    WindBelt = 1L << 37,
    LeatherGauntlet = 1L << 38
}
