...
.HandleInput(HandleConfirmation).Build();
        ...
        public bool HandleConfirmation(Aisling aisling, Dialog dialog, int? option = null)
        {
            ...
            {
                guildmate.Aisling.Client.SendServerMessage(Common.Definitions.ServerMessageType.GuildChat, $"{guildRemove.Name} has been removed from {guildRemove.GuildName}");
            }
