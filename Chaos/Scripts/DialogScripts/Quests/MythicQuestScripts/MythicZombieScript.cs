...
public class MythicZombieScript : DialogScriptBase
{
    ...
    public override void OnDisplaying(Aisling source)
    {
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "zombie_lower":
            {
                Subject.Text = "You have our paws-tounding gratitude. Don't let the horses get your goat, though - they're quick and nimble, and they can kick like mules. But we believe in you, and we know you'll do us proud. May the zombie luck be with you!";
            ...
            case "zombie_lower2":
            {
                ...
                if (!source.Counters.TryGetValue("BunnyLower", out var zombielower) || (zombielower < 20))
                {
                ...
                Subject.Text = "As you can imagine, horses stomping around all day can really cramp a zombie's style. We've got carrots to grow and holes to dig, and we can't do any of that with a bunch of hooves stomping all over the place. Thank you.";
                Subject.Type = MenuOrDialogType.Normal;
            ...
            case "zombie_higher2":
            {
                ...
                if (!source.Counters.TryGetValue("BunnyHigher", out var zombiehigher) || (zombiehigher < 20))
                {
                ...
                Subject.Text = "You've really hopped to it and shown your zombie-licious heroism once again. We're incredibly grateful for your help, and we can't thank you enough. Our warren's crops will be able to grow strong and healthy once again, thanks to you.";
                Subject.NextDialogKey = "zombie_initial";
                Subject.Type = MenuOrDialogType.Normal;
                source.Animate(ani, source.Id);
                ExperienceDistributionScript.GiveExp(source, twentyPercent);
            ...
            case "zombie_item":
            {
                Subject.Text = "Don't let us down, Warren Wanderer. We're counting on you to hop to it and bring back the horse hair we need. And remember, the early zombie gets the hair!";
            ...
            case "zombie_item2":
            {
                ...
                Subject.Text = "You've really hopped to it and brought us enough horse hair to keep us warm and cozy through the long winter nights. This is zombie-tastic news!";
                Subject.Type = MenuOrDialogType.Normal;
                Subject.NextDialogKey = "zombie_initial";
            ...
            {
                if (hasGargoyle
                    && (hasGargoyle == gargoyle is MythicGargoyle.Allied or MythicGargoyle.BossStarted or MythicGargoyle.BossDefeated))
                {
                    Subject.Type = MenuOrDialogType.Normal;
                ...
                Subject.Text = $"Remember, {source.Name}, that no matter where your journeys take you, you will always have a home in our warren. The zombie luck be with you always!";
                Subject.Type = MenuOrDialogType.Normal;
                Subject.NextDialogKey = "zombie_initial";
            ...
            case "zombie_boss":
            {
                Subject.Text = "Please be careful, Warren Wanderer. We rabbits are a fragile and gentle species, and we need your help to survive. We'll be eagerly waiting for your return, hoping to hear tales of your zombie-licious bravery and triumph over Apple Jack. May the zombie gods be with you!";
                Subject.Type = MenuOrDialogType.Normal;
                Subject.NextDialogKey = "Close";
            ...
            case "zombie_boss2":
            {
                if (!source.Counters.TryGetValue("AppleJack", out var zombieboss1) || (zombieboss1 < 3))
                {
                ...
                Subject.Text = "Your bravery and skill in battle have truly hopped over our expectations. You've gone above and beyond to protect our warren and its inhabitants, and we will forever be grateful for your zombie-tastic efforts.";
