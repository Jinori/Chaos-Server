...
public class SickChildScript : DialogScriptBase
{
    ...
    /// <inheritdoc />
    public SickChildScript(Dialog subject, IItemFactory itemFactory, ISimpleCache simpleCache)
        : base(subject)
    {
    ...
    public override void OnDisplaying(Aisling source)
    {
        ...
        var hasStage = source.Enums.TryGetValue(out SickChildStage stage);
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "paulin_quest2":
                if (!hasStage || (stage == SickChildStage.None))
                {
                    source.Enums.Set(SickChildStage.WhiteRose);
                }
                break;
            ...
            case "whiterose1-1":
                {
                    if (stage == SickChildStage.WhiteRose)
                    {
                        ...
                        source.Enums.Set(SickChildStage.WhiteRose2);
                    }
                }
                break;
            ...
            case "whiterose2-1":
                {
                    if (stage == SickChildStage.WhiteRose2)
                    {
                        ...
                        source.Inventory.RemoveQuantity("white rose", 1);
                        ExperienceDistributionScript.GiveExp(source, 50000);
                        source.Enums.Set(SickChildStage.GoldRose);
                    }
                }
                break;
            ...
            case "goldrose2":
                ...
                {
                    source.Enums.Set(SickChildStage.SickChildComplete);
            ...
            case "blackrose2":
                {
                    ...
                    {
                        source.Enums.Set(SickChildStage.BlackRose);
                    }
            ...
            case "blackrose6":
                ...
                {
                    source.Enums.Set(SickChildStage.SickChildKilled);
