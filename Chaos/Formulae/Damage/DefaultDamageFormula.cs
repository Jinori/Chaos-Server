...
public class DefaultDamageFormula : IDamageFormula
{
    protected virtual ImmutableArray<ImmutableArray<decimal>> ElementalModifierLookup { get; } = new[]
    {
        ...
        /*      None*/     new[] { 1.00m, 0.45m, 0.45m,  0.45m, 0.45m, 0.45m, 0.45m,     0.45m, 0.45m,  0.45m }.ToImmutableArray(),
        /* O    Fire*/     new[] { 2.00m, 0.50m, 1.00m,  1.50m, 1.00m, 1.00m, 1.00m,     2.01m, 0.83m,  2.01m }.ToImmutableArray(),
        /* F    Water*/    new[] { 2.00m, 1.50m, 0.50m,  1.00m, 1.00m, 0.93m, 0.83m,     0.58m, 1.74m,  0.93m }.ToImmutableArray(), 
        /* F    Wind*/     new[] { 2.00m, 1.00m, 1.00m,  0.50m, 1.50m, 0.93m, 0.83m,     1.03m, 1.74m,  0.83m }.ToImmutableArray(),
        /* E    Earth*/    new[] { 2.00m, 1.00m, 1.50m,  1.00m, 0.50m, 0.93m, 0.83m,     0.58m, 0.83m,  0.58m }.ToImmutableArray(),
        /* N    Holy*/     new[] { 2.00m, 1.25m, 1.25m,  1.25m, 1.25m, 1.25m, 1.48m,     0.58m, 0.76m,  2.01m }.ToImmutableArray(),
        /* S    Darkness*/ new[] { 2.00m, 1.25m, 1.25m,  1.25m, 1.25m, 1.48m, 0.76m,     1.48m, 0.58m,  0.58m }.ToImmutableArray(),
