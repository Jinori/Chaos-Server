...
namespace Chaos.Scripting.MerchantScripts
{
    public class MiraelisMassScript : MerchantScriptBase
    {
        ...
        private bool AnnouncedMassFiveMinutes { get; set; } = false;
        private bool AnnouncedMassOneMinute { get; set; } = false;
        
        private bool AnnouncedMassBegin { get; set; } = false;
        private DateTime? MassAnnouncementTime { get; set; }
        
        private static readonly int SERMON_DELAY_SECONDS = 5;
        private static readonly int MASS_SERMON_COUNT = 10;
        private HashSet<string> SpokenMessages { get; set; } = new HashSet<string>();
        ...
        private bool MassCompleted { get; set; } = false;
        ...
        private void PostMassActions()
        {
            ...
            foreach (var player in aislingsStillHere)
            {
                ...
                if (IntegerRandomizer.RollChance(ESSENCE_CHANCE))
                {
                    ...
                    player.SendActiveMessage($"You received an Essence of Miraelis and faith!");
                } 
                else
                {
