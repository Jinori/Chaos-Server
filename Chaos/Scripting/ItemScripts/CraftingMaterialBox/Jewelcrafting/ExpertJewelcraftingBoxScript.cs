...
public class ExpertJewelcraftingBoxScript : ItemScriptBase
{
    private static readonly Random Random = new();

    private readonly IItemFactory _itemFactory;

    public ExpertJewelcraftingBoxScript(Item subject, IItemFactory itemFactory)
        : base(subject)
    ...
    public override void OnUse(Aisling source)
    {
        ...
        var rubyAmount = Random.Next(14, 25); // 3-7
        var sapphireAmount = Random.Next(14, 25); // 3-7
        var emeraldAmount = Random.Next(14, 25); // 3-7
        var berylAmount = Random.Next(14, 25); // 3-7
        var heartstoneAmount = Random.Next(14, 25); // 3-7
