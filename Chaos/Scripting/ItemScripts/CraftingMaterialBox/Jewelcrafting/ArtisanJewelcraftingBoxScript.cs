...
public class ArtisanJewelcraftingBoxScript : ItemScriptBase
{
    private static readonly Random Random = new();

    private readonly IItemFactory _itemFactory;

    public ArtisanJewelcraftingBoxScript(Item subject, IItemFactory itemFactory)
        : base(subject)
    ...
    public override void OnUse(Aisling source)
    {
        ...
        var rubyAmount = Random.Next(4, 10); // 3-7
        var sapphireAmount = Random.Next(4, 10); // 3-7
        var emeraldAmount = Random.Next(4, 10); // 3-7
        var berylAmount = Random.Next(4, 10); // 3-7
        var heartstoneAmount = Random.Next(4, 10); // 3-7
