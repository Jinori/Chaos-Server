...
public class ArtisanEnchantingBoxScript : ItemScriptBase
{
    private static readonly Random Random = new();
    private readonly IItemFactory _itemFactory;

    public ArtisanEnchantingBoxScript(Item subject, IItemFactory itemFactory)
        : base(subject)
    ...
    public override void OnUse(Aisling source)
    {
        ...
        var totalEssences = Random.Next(14, 30);
