...
public class InitiateEnchantingBoxScript : ItemScriptBase
{
    private static readonly Random Random = new();
    private readonly IItemFactory _itemFactory;

    public InitiateEnchantingBoxScript(Item subject, IItemFactory itemFactory)
        : base(subject)
    ...
    public override void OnUse(Aisling source)
    {
        ...
        // Generate a random number of essences to give between 10 and 20
        var totalEssences = Random.Next(9, 20); // Random number between 10 and 20
