...
public class ExpertEnchantingBoxScript : ItemScriptBase
{
    private static readonly Random Random = new();
    private readonly IItemFactory _itemFactory;

    public ExpertEnchantingBoxScript(Item subject, IItemFactory itemFactory)
        : base(subject)
    ...
    public override void OnUse(Aisling source)
    {
        ...
        var totalEssences = Random.Next(29, 60);
