...
public class ExpertArmorsmithingBoxScript : ItemScriptBase
{
    private static readonly Random Random = new();

    private readonly IItemFactory _itemFactory;

    public ExpertArmorsmithingBoxScript(Item subject, IItemFactory itemFactory)
        : base(subject)
    ...
    public override void OnUse(Aisling source)
    {
        ...
        var hempAmount = Random.Next(29, 50); // 29-50
