...
public class ExpertWeaponsmithingBoxScript : ItemScriptBase
{
    private static readonly Random Random = new();

    private readonly IItemFactory _itemFactory;

    public ExpertWeaponsmithingBoxScript(Item subject, IItemFactory itemFactory)
        : base(subject)
    ...
    public override void OnUse(Aisling source)
    {
        ...
        var azuriumAmount = Random.Next(9, 20); // 3-7
        var crimsoniteAmount = Random.Next(9, 20); // 3-7
