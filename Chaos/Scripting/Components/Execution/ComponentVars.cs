...
public virtual void SetBaseDamage(Creature creature, int baseDamage)
    ...
    public virtual void SetFinalDamage(Creature creature, int finalDamage) => Set($"{FINAL_DAMAGE}-{creature.Id}", finalDamage);    public virtual void SetOptions(object options)
    {
        switch (options)
        {
