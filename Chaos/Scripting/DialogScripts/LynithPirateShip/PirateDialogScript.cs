...
public class PirateDialogScript : DialogScriptBase
{
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            case "saltysam_initial":
            {
                if (source.UserStatSheet.Level < 11)
                {
                    ...
                    Subject.Reply(source,
                        "Welcome to my galley! Oh, you're small... Who let you in? Let's get you somewhere safe.");
            ...
            case "jollyroger_initial":
            {
                if (source.UserStatSheet.Level < 11)
                {
                    var pointhome = new Point(5, 8);
                    Subject.Reply(source,
                        "You're too young to be here... how did you even get on the ship? Let's get you somewhere safe.");
            ...
            case "savagesable_initial":
            {
                if (source.UserStatSheet.Level < 11)
                {
                    var pointhome = new Point(5, 8);
                    Subject.Reply(source,
                        "You're a small fella, like me! Let's get you somewhere safe.");
    ...
    private bool HasPirateArmor(Aisling source)
    {
        ...
        var hasPirateArmor = armor != null && (armor.DisplayName.EqualsI("M Pirate Shirt") 
                                               || armor.DisplayName.EqualsI("F Pirate Blouse") 
                                               || armor.DisplayName.EqualsI("M Pirate Garb") 
                                               || armor.DisplayName.EqualsI("F Pirate Dress"));

        var hasPirateHelmet = helmet != null && (helmet.DisplayName.EqualsI("Red Pirate Bandana") 
