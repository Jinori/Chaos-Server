...
public class HelpSableScript : DialogScriptBase
{
    ...
    /// <inheritdoc />
    public HelpSableScript(Dialog subject, ISimpleCache simpleCache, ILogger<PFQuestScript> logger)
        : base(subject)
    {
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "helpsable_return":
            {
                if (!source.Inventory.HasCount("Red Pirate Bandana", 1))
                {
                    Subject.Reply(
                        source,
                        "I thought we discussed you bringing me a Red Pirate Bandana? Well? Where is it? It doesn't matter now, enjoy the brig!");
                ...
                Logger.WithTopics(
                      ...
                      .LogInformation("{@AislingName} has received {@ExpAmount} exp and Blue Cloak from Helping Sable", source.Name, 75000);
            }
