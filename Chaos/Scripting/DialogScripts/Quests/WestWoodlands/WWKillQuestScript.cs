        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "wwkillquest_initial":
            {
                ...
                if (source.UserStatSheet.Level >= 71)
                {
                    ...
                    Subject.Reply(source, "This place is now beneath you Aisling, go forth and defeat stronger creatures.");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("wwgoblinguardcounter", out var goblinguard) || (goblinguard < 10))
                    {
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("wwgoblinwarriorcounter", out var wwgoblinwarrior) || (wwgoblinwarrior < 10))
                    {
                        Subject.Reply(source, "I wonder if you can handle 10 Goblin Warriors... maybe it was too hard?", "maxwell_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("wwhobgoblincounter", out var hobgoblin) || (hobgoblin < 10))
                    {
                        Subject.Reply(
                            source,
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("wwshriekercounter", out var shrieker) || (shrieker < 10))
                    {
                        Subject.Reply(
                            source,
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("wwwispcounter", out var wisp) || (wisp < 10))
                    {
                        Subject.Reply(
                            source,
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("wwfaeriecounter", out var faerie) || (faerie < 10))
                    {
                        Subject.Reply(
                            source,
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("wwbosscounter", out var twink) || (twink < 1))
                    {
                        Subject.Reply(source, "Is the Twink giving you troubles? He isn't weak, good luck!", "maxwell_initial");
            ...
            case "wwkillquest_start":
            {
                ...
                if (source.UserStatSheet.Level <= 55)
                {
                    if (roll < 33)
                    {
                        ...
                        Subject.Reply(source, "There's some strong Goblin Guards in there, take down 10 of them.", "Close");
