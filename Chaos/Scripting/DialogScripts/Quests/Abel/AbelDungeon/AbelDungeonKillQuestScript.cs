        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "abeldungeonkillquest_initial":
            {
                ...
                if (hasStage && stage == AbelDungeonKillQuestStage.DungeonLeech)
                {
                    ...
                    {
                        Subject.Reply(source, "Leechs carry many diseases, it's important we rid 10 of them from the dungeon.", "nico_initial");
                        return;
                    }
                    ...
                    Subject.Reply(source,
                        $"The dungeon is already a safer place, thank you Aisling.",
                        "nico_initial");
                    source.TryGiveGamePoints(5);
                    ExperienceDistributionScript.GiveExp(source, tenPercent);
                    source.Trackers.TimedEvents.AddEvent("abeldungeoncd", TimeSpan.FromHours(24), true);
                ...
                if (hasStage && stage == AbelDungeonKillQuestStage.DungeonSpore)
                {
                    ...
                    Subject.Reply(source,
                        $"That'll do the trick, good job Aisling.",
                        "nico_initial");
                    source.TryGiveGamePoints(5);
                    ExperienceDistributionScript.GiveExp(source, tenPercent);
                    source.Trackers.TimedEvents.AddEvent("abeldungeoncd", TimeSpan.FromHours(24), true);
                ...
                if (hasStage && stage == AbelDungeonKillQuestStage.DungeonPolyp)
                {
                    ...
                    {
                        Subject.Reply(source, "Polyps are quite the creature aren't they? How do they breath? Anyway take out 10 for me.", "nico_initial");
                        return;
                    }
                    ...
                    Subject.Reply(source,
                        $"I knew I could count on you, glad that's over with.",
                        "nico_initial");
                    source.TryGiveGamePoints(5);
                    ExperienceDistributionScript.GiveExp(source, tenPercent);
                    source.Trackers.TimedEvents.AddEvent("abeldungeoncd", TimeSpan.FromHours(24), true);
                ...
                if (hasStage && stage == AbelDungeonKillQuestStage.DungeonDwarf)
                {
                    ...
                    {
                        Subject.Reply(source, "The dwarfs down there are pretty mean. It's important we eliminate 10 from the dungeon.", "nico_initial");
                        return;
                    }
                ...
                if (hasStage && stage == AbelDungeonKillQuestStage.DungeonDwarfSoldier)
                {
                    ...
                    {
                        Subject.Reply(source, "Those Dwarf Soldiers are part of their army, an army too powerful can pose a threat. Please go kill 10 of them.", "nico_initial");
                        return;
                    }
            ...
            case "abeldungeonkillquest_start":
            {
                ...
                if (source.UserStatSheet.Level < 85)
                {
                    switch (roll)
                    {
                        ...
                        {
                            Subject.Reply(source,
                                "Glupes can be hard to kill, but I'm sure you'll manage. Kill 10 Glupes.",
                                "Close");
                    ...
                    Subject.Reply(source,
                                "Leechs are diseased in the dungeon so be careful, slay 10 of the Leechs for me.",
                                "Close");
                ...
                if (source.UserStatSheet.Level is >= 85 and < 97)
                {
                    switch (roll)
                    {
                        ...
                        case < 66:
                            ...
                            Subject.Reply(source,
                                "The Spores in the dungeon are becoming a problem, go take out 10 Spores.",
                                "Close");
                            return;
                    }
