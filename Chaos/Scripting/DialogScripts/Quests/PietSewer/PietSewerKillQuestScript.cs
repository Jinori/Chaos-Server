        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "pietsewerkillquest_initial":
            {
                ...
                if (hasStage && (stage == PietSewerKillQuestStage.SewerCrab))
                {
                    ...
                    Subject.Reply(source, "Well done. Come back soon.", "waldyr_initial");
                ...
                if (hasStage && (stage == PietSewerKillQuestStage.SewerTurtle))
                {
                    ...
                    Subject.Reply(source, "A job well done. Thank you Aisling.", "waldyr_initial");
                    source.TryGiveGamePoints(5);
                    ExperienceDistributionScript.GiveExp(source, tenPercent);
                    source.Trackers.TimedEvents.AddEvent("pietsewercd", TimeSpan.FromHours(22), true);
                ...
                if (hasStage && (stage == PietSewerKillQuestStage.SewerFrog))
                {
                    ...
                    Subject.Reply(source, "The frogs are all over, that didn't take you very long, thank you.", "waldyr_initial");
                    source.TryGiveGamePoints(5);
                    ExperienceDistributionScript.GiveExp(source, tenPercent);
                    source.Trackers.TimedEvents.AddEvent("pietsewercd", TimeSpan.FromHours(22), true);
                ...
                if (hasStage && (stage == PietSewerKillQuestStage.SewerAnemone))
                {
                    ...
                    Subject.Reply(source, "Much better, those things are really bothersome.", "waldyr_initial");
                    source.TryGiveGamePoints(5);
                    ExperienceDistributionScript.GiveExp(source, tenPercent);
                    source.Trackers.TimedEvents.AddEvent("pietsewercd", TimeSpan.FromHours(22), true);
                ...
                if (hasStage && (stage == PietSewerKillQuestStage.SewerBrawlfish))
                {
                    if (!source.Trackers.Counters.TryGetValue("sewerbrawlfishcounter", out var spore) || (spore < 10))
                    {
                        Subject.Reply(
                            source,
                            "The brawlfish can be very difficult, stubborn little monsters. Kill 10 of them, show them who's boss.",
                            "waldyr_initial");
                ...
                if (hasStage && (stage == PietSewerKillQuestStage.SewerRockCobbler))
                {
                    if (!source.Trackers.Counters.TryGetValue("sewerrockcobblercounter", out var rockcobbler) || (rockcobbler < 10))
                    {
                        Subject.Reply(
                            source,
                            "Rock Cobblers are very defensive creatures, killing them can be pretty tough. But you seem tough yourself, go ahead and handle 10 of them.",
                            "waldyr_initial");
                ...
                if (hasStage && (stage == PietSewerKillQuestStage.SewerKraken))
                {
                    if (!source.Trackers.Counters.TryGetValue("sewerkrakencounter", out var kraken) || (kraken < 10))
                    {
                        Subject.Reply(
                            source,
                            "Krakens down in the sewers are a strange sight, but they love it and it's difficult to get them out of there. Keep at it, only need to kill 10.",
                            "waldyr_initial");
                ...
                if (source.UserStatSheet.Level < 50)
                    switch (roll)
                    {
                        case < 25:
                            ...
                            Subject.Reply(source, "Ah, this task is easy, go defeat 10 crabs and return to me.", "Close");
                ...
                if (source.UserStatSheet.Level is >= 50 and <= 70)
                {
                    switch (roll)
                    {
                        case < 25:
                            ...
                            Subject.Reply(
                                source,
                                "Brawlfish are territorial creatures, difficult to get rid of. Can you slay 10 of them for me?",
                                "Close");
