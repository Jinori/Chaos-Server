    ...
    public override void OnDisplaying(Aisling source)
    {
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "ewkillquest_initial":
            {
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewvipercounter", out var viper) || (viper < 10))
                    {
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewbeecounter1", out var ewbee1) || (ewbee1 < 10))
                    {
                        Subject.Reply(
                            source,
                            "The bees in the enchanted garden aren't so bad but they're over populated. Go clear 10 of them.",
                            "ghislain_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewbeecounter2", out var ewbee2) || (ewbee2 < 10))
                    {
                        Subject.Reply(
                            source,
                            "I know those bees can be painful with their stingers but it's important, they must die.",
                            "ghislain_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewmantiscounter1", out var ewmantis1) || (ewmantis1 < 10))
                    {
                        Subject.Reply(
                            source,
                            "The mantis in the Enchanted Garden can be very sneaky, they blend so well with the grass. I understand you are struggling, but you can do this. Go slay 10 Mantis.",
                            "ghislain_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewmantiscounter2", out var ewmantis2) || (ewmantis2 < 10))
                    {
                        Subject.Reply(
                            source,
                            "The mantis are dangerous foes but don't fear. I have faith in you. Kill 10 of the mantis.",
                            "ghislain_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewwolfcounter", out var ewwolf) || (ewwolf < 10))
                    {
                        Subject.Reply(
                            source,
                            "Heh, having trouble with the wolves? I can sense your fear, so they can too. Overcome it, slay 10 wolves.",
                            "ghislain_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewkoboldcounter", out var ewkobold) || (ewkobold < 10))
                    {
                        Subject.Reply(
                            source,
                            "Those verticle dogs are hardly standing. Go knock them over and kill them with ease. Slay 10 Kobolds.",
                            "ghislain_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewgoblinsoldiercounter", out var ewgoblinsoldier) || (ewgoblinsoldier < 10))
                    {
                        Subject.Reply(
                            source,
                            "Goblin Soldiers can be tough but they're only following orders. There's no reasoning with them, slay 10 goblin soldiers.",
                            "ghislain_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewgoblinwarriorcounter", out var ewgoblinwarrior) || (ewgoblinwarrior < 10))
                    {
                        Subject.Reply(
                            source,
                            "Goblin Warriors are loyal to their brethren and cannot be reasoned with. Please slay 10 Goblin Warriors.",
                            "ghislain_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewgoblinguardcounter", out var ewgoblinguard) || (ewgoblinguard < 10))
                    {
                        Subject.Reply(
                            source,
                            "Goblin Guards sole purpose is to defend their chiefs. They will stop at nothing to keep their chiefs safe. You must slay 10 Goblin Guards.",
                            "ghislain_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("ewhobgoblincounter", out var ewhobgoblin) || (ewhobgoblin < 10))
                    {
                        Subject.Reply(
                            source,
                            "Hobgoblins are incredibly different from normal goblins. They don't care for orders or authority. That makes them even more dangerous. Please go kill 10 Hobgoblins.",
                            "ghislain_initial");
            ...
            case "ewkillquest_start":
            {
                ...
                if (source.UserStatSheet.Level <= 11)
                {
                    if (roll < 33)
                    {
                        ...
                        Subject.Reply(source, "Take down 10 Vipers from the Enchanted Garden.", "Close");
                ...
                if (source.UserStatSheet.Level is >= 12 and <= 25)
                {
                    if (roll < 25)
                    {
                        ...
                        Subject.Reply(
                            source,
                            "Those mantis in the forest have been catching Aislings off guard. Go handle 10 of them for me.",
                            "Close");
                    ...
                    if (roll < 50)
                    {
                        ...
                        Subject.Reply(source, "The wolves are no match for you Aisling, go slay 10 of them quickly.", "Close");
                ...
                if (source.UserStatSheet.Level > 36)
                {
                    ...
                    Subject.Reply(
                        source,
                        "The hobgoblins are the only thing left for you to take down. Please go defeat 10 of them.",
                        "Close");
                }
