                    ...
                    switch (hasRequiredPinkRoses)
                    {
                        case true:
                        {
                            ...
                            logger.WithTopics(
                                  ...
                                  .LogInformation("{@AislingName} has received {@ExpAmount} exp from a quest", source.Name, 125000);
                        ...
                        case false:
                        {
                            ...
                            Subject.Reply(source, $"{pinkrosecount} Pink Roses are not a full bouquet. Please bring back 5 Pink Roses.");
