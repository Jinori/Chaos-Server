    ...
    public override void OnDisplaying(Aisling source)
    {
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            case "kobold_initial":
            {
                ...
                {
                    Subject.Reply(source, "Are the Grimlock Workers cleared? My people are already in position.");
                ...
                {
                    Subject.Reply(source, "Their forces seem to be really riled up. Did you kill the 10 Grimlock Guards and 10 Grimlock Rogues?");
                ...
                {
                    Subject.Reply(source, "Hare-oic Aisling! Did you collect all the horse hair?");
