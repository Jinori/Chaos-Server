    ...
    public override void OnDisplaying(Aisling source)
    {
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            case "bee_initial":
            {
                ...
                {
                    Subject.Text =
                        "Buzz buzz, welcome to my hive, little one. I am the Bee Queen, ruler of these lands. For centuries, my hive has been at war with the Mantis Colony, those vicious and ruthless hunters. They have no respect for the hard work and sacrifice of my bees. We've been stuck in this sticky situation for far too long. They constantly attack our hive and steal our precious honey, leaving us with little to sustain ourselves.";
                ...
                {
                    Subject.Text =
                        "Ah, welcome back, my industrious friend! I see that you have returned to our hive, buzzing with the excitement of your latest mission. Your efforts have certainly created quite a buzz around here! Did you get rid of those mantis?";
                ...
                {
                    Subject.Text =
                        "Greetings, my dear buzz-worthy friend! We have identified a congregation of mantis that are a different species from before. They are blocking our access to some crucial flowers deeper in the forest. We simply cannot get to them without your help. ";
                ...
                {
                    Subject.Text =
                        "Greetings, my busy bee friend! I'm abuzz with excitement to see you again. I hope your wings aren't too tired from all the flying. Is the area clear for my worker bees? Can we get that sweet nectar?";
                ...
                {
                    Subject.Text =
                        "I have a new task for you, and it's sure to be a real honey of a mission. We need you to buzz around and collect some dendron flowers for us. The Mantis Colony uses them to lure in my workers, you can probably take them from any of the mantis.";
                ...
                {
                    Subject.Text =
                        "We bees are known for our loyalty and hard work. And we always stick together as a hive. So, the choice is yours: will you be a busy bee and join us in our fight, or will you be a drone and buzz off?\n((Remember, you may only have up to 5 Alliances and you cannot remove alliances.))";
            ...
            case "bee_ally":
            {
                ...
                Subject.Text = $"So let me just say, we're pollen for you {source.Name
