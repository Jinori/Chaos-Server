        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            case "bee_initial":
            {
                if (hasBee && (bee == MythicBee.EnemyAllied))
                    Subject.Reply(source, "I cannot allow a member of the hive to be allied with our enemies. It puts our entire colony at risk, and I simply cannot tolerate it. So, I must ask you to leave our hive and never return.");
                ...
                if (bee == MythicBee.BossDefeated)
                    Subject.Reply(source, "The whole hive is buzzing about your efforts, you're an honorary bee around here. Thank you again!");
            ...
            case "bee_lower2":
            {
                ...
                Subject.Reply(source,
                    "Your bravery and dedication have not gone unnoticed. By eliminating some of the mythic mantis, we can now send our workers to gather pollen and nectar without fear of attack.", "bee_initial");
            ...
            case "bee_higher2":
            {
                ...
                Subject.Reply(source,
                    "Thank you from the bottom of my queenly heart. You truly are the pollen to our flower. Buzz on, my dear bee protector!", "bee_initial");
            ...
            case "bee_item2":
            {
                ...
                Subject.Reply(source,
                    "With these flowers, we will be able to produce the most delicious and nutritious nectar that will keep our hive buzzing with joy and energy. You have truly outdone yourself this time, my dear ally.", "bee_initial");
            ...
            case "bee_ally":
            {
                ...
                Subject.Reply(source, $"So let me just say, we're pollen for you {source.Name}! It's bee-n a long time since we've had such a dedicated ally in our fight against the mantis colony. With you on our side, we can bee unstoppable!", "bee_initial");
