    ...
    public override void OnDisplaying(Aisling source)
    {
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "bunny_lower2":
            {
                ...
                Subject.Reply(source,
                    "As you can imagine, horses stomping around all day can really cramp a bunny's style. We've got carrots to grow and holes to dig, and we can't do any of that with a bunch of hooves stomping all over the place. Thank you.", "bunny_initial");
            ...
            case "bunny_higher2":
            {
                ...
                Subject.Reply(source,
                    "You've really hopped to it and shown your bunny-licious heroism once again. We're incredibly grateful for your help, and we can't thank you enough. Our warren's crops will be able to grow strong and healthy once again, thanks to you.", "bunny_initial");
            ...
            case "bunny_item2":
            {
                ...
                Subject.Reply(source,
                    "You've really hopped to it and brought us enough horse hair to keep us warm and cozy through the long winter nights. This is bunny-tastic news!", "bunny_initial");
            ...
            case "bunny_ally":
            {
                ...
                Subject.Reply(source, $"Remember, {source.Name}, that no matter where your journeys take you, you will always have a home in our warren. The bunny luck be with you always!", "bunny_initial");
