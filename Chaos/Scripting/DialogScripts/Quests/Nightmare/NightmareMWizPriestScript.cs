            ...
            case "gregory_initial":
            {
                switch (hasStage)
                {
                    ...
                    case true when stage == NightmareQuestStage.CompletedNightmareWin1:
                        Subject.Reply(
                            source,
                            "Good job on your victory, I knew I told the right Aisling. Please, take this, you have done very well.");
                    ...
                    case true when stage == NightmareQuestStage.CompletedNightmareLoss1:
                        Subject.Reply(
                            source,
                            "You may have lost the battle, but you haven't lost the war. Press on and try to forget about it.");
