    ...
    public override void OnDisplaying(Aisling source)
    {
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "astridkillquest_initial":
            {
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("astridwolfcounter", out var wolf) || (wolf < 10))
                    {
                        Subject.Reply(
                            source,
                            "Why are you back so soon? That isn't enough wolves! I need 10 of them dead! Get back in there!",
                            "phio_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("astridkoboldcounter", out var kobold) || (kobold < 10))
                    {
                        Subject.Reply(
                            source,
                            "You thought you can handle them huh? You're back already, so weak. Get back in there and kill 10!",
                            "phio_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("astridgoblinguardcounter", out var goblinguard) || (goblinguard < 10))
                    {
                        Subject.Reply(
                            source,
                            "They kicked your ass didn't they? I knew they would. You even look weak. Go try again, remember 10 of the Goblin Guards need to be killed!",
                            "phio_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("astridgoblinsoldiercounter", out var goblinsoldier) || (goblinsoldier < 10))
                    {
                        Subject.Reply(
                            source,
                            "Figures, I put the wrong Aisling up to the task. Get lost, come back when you've killed 10 Goblin Soldiers.",
                            "phio_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("astridgoblinwarriorcounter", out var goblinwarrior) || (goblinwarrior < 10))
                    {
                        Subject.Reply(
                            source,
                            "Really? Back so soon? I thought you had more fight in you, pathetic. Try again, remember 10 of the Goblin Warriors need to be killed.",
                            "phio_initial");
            ...
            case "astridkillquest_start":
            {
                ...
                if (source.UserStatSheet.Level < 30)
                {
                    ...
                    Subject.Reply(source, "A fight is what you'll get! Go kill 10 Kobolds for me then.", "Close");
                ...
                if (source.UserStatSheet.Level >= 30)
                {
                    ...
                    Subject.Reply(source, "Think you can really handle it? Well let's see it then. Go kill 10 Goblin Soldiers.", "Close");
