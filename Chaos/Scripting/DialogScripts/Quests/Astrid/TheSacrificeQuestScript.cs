        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "thesacrifice_initial":
            {
                if (source.Trackers.TimedEvents.HasActiveEvent("thesacrificecd", out var cdtime))
                {
                    Subject.Reply(
                        source,
                        $"Thank you again for your help Aisling. I may need your help again soon. (({cdtime.Remaining.ToReadableString()}))",
                        "chloe_initial");
                ...
                if (hasStage && (stage == TheSacrificeQuestStage.Reconaissance))
                {
                    ...
                    if (numFlags >= 3)
                    {
                        ...
                        Subject.Reply(
                            source,
                            $"Wow! You scouted out {numFlags.ToWords()} spots! That's impressive you were able to avoid the goblins and kobolds. Thank you! This will help us find the children.",
                            "chloe_initial");
                    ...
                    Subject.Reply(
                        source,
                        "This isn't enough information. Go scout more spots and return to me with something I can really use! Remember to look at the points on the star.",
                        "chloe_initial");
                ...
                {
                    source.Trackers.Counters.TryGetValue("captorkills1", out var captorkills1);
                    source.Trackers.Counters.TryGetValue("captorkills2", out var captorkills2);
                    ...
                    if (killamount >= 10)
                    {
                        ...
                        Subject.Reply(
                            source,
                            $"You killed {killamount.ToWords()} captors! That'll hurt them for sure! They will think twice about taking our kids again! Thank you for your heroic actions.",
                            "chloe_initial");
                    ...
                    Subject.Reply(
                        source,
                        "You haven't killed enough to be useful. I don't think that'll get us anywhere. Go slay some more, make them regret taking the children!",
                        "chloe_initial");
                ...
                if (hasStage && (stage == TheSacrificeQuestStage.RescueChildren))
                {
                    ...
                    Subject.Reply(
                        source,
                        "Where are the children?! You returned without a child? I thought you were going to find them. Go! Search for the children in Astrid!",
                        "chloe_initial");
                }
