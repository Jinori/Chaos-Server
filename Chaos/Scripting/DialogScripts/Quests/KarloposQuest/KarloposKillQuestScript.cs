    ...
    public override void OnDisplaying(Aisling source)
    {
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            case "karloposkillquest_initial":
            {
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("karloposcrabcounter", out var crab) || (crab < 10))
                    {
                    ...
                    Subject.Reply(source, "Nice Job! Come back soon.", "kregg_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("karloposturtlecounter", out var turtle) || (turtle < 10))
                    {
                        Subject.Reply(
                            source,
                            "The turtles may be a little hard to kill, but you can do it. Only need 10 of them terminated.",
                            "kregg_initial");
                    ...
                    Subject.Reply(source, "That will be enough. Thank you Aisling.", "kregg_initial");
                    source.TryGiveGamePoints(5);
                    ExperienceDistributionScript.GiveExp(source, tenPercent);
                    source.Trackers.TimedEvents.AddEvent("karloposslayercd", TimeSpan.FromHours(22), true);
                    source.Trackers.Counters.Remove("karloposturtlecounter", out _);
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("karloposslugcounter", out var slug) || (slug < 10))
                    {
                    ...
                    Subject.Reply(source, "Great! They're such a horrid sight, I'm glad they are gone.", "kregg_initial");
                    source.TryGiveGamePoints(5);
                    ExperienceDistributionScript.GiveExp(source, tenPercent);
                    source.Trackers.TimedEvents.AddEvent("karloposslayercd", TimeSpan.FromHours(22), true);
                    source.Trackers.Counters.Remove("karloposslugcounter", out _);
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("karlopossporecounter", out var spore) || (spore < 10))
                    {
                        Subject.Reply(
                            source,
                            "Spores can be a challenge but an Aisling like yourself shouldn't be having this much trouble. It's only 10 of them, I usually do it in my sleep!",
                            "kregg_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("karloposkrakencounter", out var kraken) || (kraken < 10))
                    {
                        Subject.Reply(
                            source,
                            "The krakens in there are nuts! You may be weak but it doesn't mean give up! Slaughter 10 Kraken for me please.",
                            "kregg_initial");
                    ...
                    Subject.Reply(source, "I knew you had it in you, that's what I'm talking about.", "kregg_initial");
                    source.TryGiveGamePoints(5);
                    ExperienceDistributionScript.GiveExp(source, tenPercent);
                    source.Trackers.TimedEvents.AddEvent("karloposslayercd", TimeSpan.FromHours(22), true);
                    source.Trackers.Counters.Remove("karloposkrakencounter", out _);
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("karloposoctopuscounter", out var octopus) || (octopus < 10))
                    {
                        Subject.Reply(
                            source,
                            "I know I asked for 10 Octopus, that's 80 legs of meat! I think you can do it.",
                            "kregg_initial");
                ...
                {
                    if (!source.Trackers.Counters.TryGetValue("karloposgogcounter", out var gog) || (gog < 10))
                    {
                        Subject.Reply(
                            source,
                    ...
                    Subject.Reply(source, "Glad those are gone now, the beaches will be so much prettier to walk!", "kregg_initial");
                    source.TryGiveGamePoints(5);
                    ExperienceDistributionScript.GiveExp(source, tenPercent);
                    source.Trackers.TimedEvents.AddEvent("karloposslayercd", TimeSpan.FromHours(22), true);
                    source.Trackers.Counters.Remove("karloposgogcounter", out _);
            ...
            case "karloposkillquest_start":
            {
                ...
                if (source.UserStatSheet.Level < 60)
                {
                    if (roll < 33)
                    {
                        ...
                        Subject.Reply(source, "Go crack open some crabs, 10 of them to be exact!", "Close");
                    ...
                    Subject.Reply(source, "Slugs are gross, but I bet you know how to handle them. Kill 10 Slugs for me.", "Close");
                ...
                if (source.UserStatSheet.Level is >= 60 and <= 70)
                {
                    ...
                    Subject.Reply(source, "The Gogs are so ugly, will you be able to clear 10 please.", "Close");
