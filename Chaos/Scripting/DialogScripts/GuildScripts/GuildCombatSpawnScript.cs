...
public class GuildCombatSpawnScript(Dialog subject, IMonsterFactory monsterFactory) : DialogScriptBase(subject)
{
    ...
    private static Rectangle DetermineCombatArea(string bossKey)
        => bossKey switch
        {
            "guildcarnun" => new Rectangle(
                59,
                25,
                11,
                10),
            "firelord_boss" => new Rectangle(
                65,
                30,
                15,
                12),
            "icebeast_boss" => new Rectangle(
                45,
                15,
                12,
                10),
