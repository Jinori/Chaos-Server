...
public class GuildManagementScript : GuildScriptBase
{
    ...
    public override void OnDisplaying(Aisling source)
    {
        ...
        if (!IsInGuild(source, out _, out var sourceRank))
            ...
            Subject.AddOptions(
                ("Guild Bank", "generic_guildbank_initial"),
            ...
            Subject.AddOptions(("Guild Bank", "generic_guildbank_initial"), ("Members", "generic_guild_members_initial"), ("Leave", "generic_guild_leave_initial"));
    }
}