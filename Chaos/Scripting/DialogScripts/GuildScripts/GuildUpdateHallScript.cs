...
public class GuildUpdateHallScript : DialogScriptBase
{
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            case "tibbs_purchase_house":
                HandleUpgrade(
                    ...
                    guildName,
                    "deed",
                    "You do not have enough gold or game points to purchase a deed.");
            ...
            case "tibbs_purchase_tailor_confirm":
                HandleUpgrade(
                    ...
                    guildName,
                    "tailor",
                    "You do not have enough gold or game points to purchase a tailor.");
            ...
            case "tibbs_purchase_armory_confirm":
                HandleUpgrade(
                    ...
                    guildName,
                    "armory",
                    "You do not have enough gold or game points to purchase an armory.");
            ...
            case "tibbs_purchase_bank_confirm":
                HandleUpgrade(
                    ...
                    guildName,
                    "bank",
                    "You do not have enough gold or game points to purchase a bank.");
            ...
            case "tibbs_purchase_combatroom_confirm":
                HandleUpgrade(
                    ...
                    guildName,
                    "combatroom",
                    "You do not have enough gold or game points to purchase a combat room.");
    ...
    private void SpawnNPCsForMorphCode(Aisling source, string morphCode)
    {
        ...
        var existingNPCs = source.MapInstance
