...
namespace Chaos.Scripting.DialogScripts.Generic
{
    public class ClassDyeStripperScript(Dialog subject, IItemFactory itemFactory) : DialogScriptBase(subject)
    {
        ...
        [
            "earthbodice", "lotusbodice", "moonbodice", "lightninggarb", "seagarb", "dobok", "culotte", "earthgarb",
            "windgarb", "mountaingarb", "gorgetgown", "mysticgown", "elle", "dolman", "bansagart", "cowl",
            "galuchatcoat",
            "mantle", "hierophant", "dalmatica", "cotte", "brigandine", "corsette", "pebblerose", "kagum",
            "scoutleather", "dwarvishleather", "paluten", "keaton", "bardocle", "leatherbliaut", "cuirass",
            "cotehardie", "kasmaniumhauberk", "labyrinthmail", "leathertunic", "jupe", "lorica", "chainmail",
            "platemail",
            "magiskirt", "benusta", "stoller", "clymouth", "clamyth", "gardcorp", "journeyman", "lorum", "mane",
            "duinuasal"
        ];
        ...
        private void OnDisplayingAccepted(Aisling source)
        {
            ...
            if (!(item.Template.TemplateKey.StartsWithI("mileth") || item.Template.TemplateKey.StartsWithI("rucesion") || 
                  item.Template.TemplateKey.StartsWithI("loures") || item.Template.TemplateKey.StartsWithI("suomi")))
            {
                Subject.Close(source);
            ...
            var dyePrefixes = new List<string> { "mileth", "rucesion", "loures", "suomi" };
        ...
        private void OnDisplayingInitial(Aisling source) => Subject.Slots =
            source.Inventory.Where(x => 
                x.Template.TemplateKey.StartsWithI("mileth") || 
