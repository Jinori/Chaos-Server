...
public class AdminTrinketScript : DialogScriptBase
{
    ...
    public AdminTrinketScript(Dialog subject, ISimpleCache cache, ISimpleCacheProvider cacheProvider, IClientRegistry<IWorldClient> clientRegistry) : base(subject)
    {
