...
public class TerminusHideEquipmentScript : DialogScriptBase
{
    ...
    private void AddGearToggleOption(
        InvisibleGear flag,
        string gearName,
        InvisibleGear currentGear,
        string dialogKey)
    {
    ...
    public override void OnDisplaying(Aisling source)
    {
        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
            ...
            {
                AddGearToggleOption(
                    InvisibleGear.HideHelmet,
                    "Helmet",
                    gear,
                    "terminus_toggle_helmet");

                AddGearToggleOption(
                    InvisibleGear.HideWeapon,
                    "Weapon",
                    gear,
                    "terminus_toggle_weapon");

                AddGearToggleOption(
                    InvisibleGear.HideShield,
                    "Shield",
                    gear,
                    "terminus_toggle_shield");

                AddGearToggleOption(
                    InvisibleGear.HideBoots,
                    "Boots",
                    gear,
                    "terminus_toggle_boots");

                AddGearToggleOption(
                    InvisibleGear.HideArmor,
                    "Armor",
                    gear,
                    "terminus_toggle_armor");

                AddGearToggleOption(
                    InvisibleGear.HideAccessoryOne,
                    "Accessory One",
                    gear,
                    "terminus_toggle_accessory1");

                AddGearToggleOption(
                    InvisibleGear.HideAccessoryTwo,
                    "Accessory Two",
                    gear,
                    "terminus_toggle_accessory2");

                AddGearToggleOption(
                    InvisibleGear.HideAccessoryThree,
                    "Accessory Three",
                    gear,
                    "terminus_toggle_accessory3");
