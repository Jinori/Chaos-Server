        ...
        switch (Subject.Template.TemplateKey.ToLower())
        {
                ...
                switch (FauxItem?.Template.TemplateKey.ToLower())
                {
                    ...
                    case "stronghastebrewformula":
                        Subject.Reply(
                            source,
                            $"{FauxItem.Template.Name
                            } requires 1 Spark Flower, 2 Greater Monster Extract and 1 Empty Bottle.",
                            "alchemybook");
                    ...
                    case "strongpowerbrewformula":
                        Subject.Reply(
                            source,
                            $"{FauxItem.Template.Name
                            } requires 1 Cactus Flower, 2 Greater Monster Extract and 1 Empty Bottle.",
                            "alchemybook");
                    ...
                    case "strongaccuracypotionformula":
                        Subject.Reply(
                            source,
                            $"{FauxItem.Template.Name
                            } requires 1 Kabine Blossom, 2 Greater Monster Extract and 1 Empty Bottle.",
                            "alchemybook");
                    ...
                    case "statboostelixirformula":
                        Subject.Reply(
                            source,
                            $"{FauxItem.Template.Name
                            } requires 1 Marauder's Spine, 1 Satyr's Hoof, 1 Polyp Sac, 2 Greater Monster Extract and 1 Empty Bottle.",
                            "alchemybook");
                    ...
                    case "knowledgeelixirformula":
                        Subject.Reply(
                            source,
                            $"{FauxItem.Template.Name
                            } requires 1 Gruesomefly Wing, 2 Greater Monster Extract, 1 Lion Fish and 1 Empty Bottle.",
                            "alchemybook");
                    ...
                    case "potentastralbrewformula":
                        Subject.Reply(
                            source,
                            $"{FauxItem.Template.Name
                            } requires 1 Passion Flower, 2 Superior Monster Extract and 1 Empty Bottle.",
                            "alchemybook");
                    ...
                    case "invisibilitypotionformula":
                        Subject.Reply(
                            source,
                            $"{FauxItem.Template.Name
                            } requires 1 Kobold Tail, 2 Superior Monster Extract and 1 Empty Bottle.",
                            "alchemybook");
                    ...
                    case "strongstatboostelixirformula":
                        Subject.Reply(
                            source,
                            $"{FauxItem.Template.Name
                            } requires 1 Losgann Tail, 1 Red Shocker Piece, 1 Ice Skeleton Skull, 2 Superior Monster Extract and 1 Empty Bottle.",
                            "alchemybook");
                    ...
                    case "strongknowledgeelixirformula":
                        Subject.Reply(
                            source,
                            $"{FauxItem.Template.Name
                            } requires 1 Skeleton Bones, 1 Lion Fish, 2 Superior Monster Extract and 1 Empty Bottle.",
                            "alchemybook");
            ...
            case "enchantingbook":
            {
                ...
                switch (FauxItem?.Template.TemplateKey.ToLower())
                {
                    ...
                    case "geolithbarrier":
                    {
                        Subject.Reply(source, $"{FauxItem.Template.Name} requires 15 Essence of Geolith.", "enchantingbook");
                    ...
                    case "geolithtestimony":
                    {
                        Subject.Reply(source, $"{FauxItem.Template.Name} requires 10 Essence of Geolith.", "enchantingbook");
                    ...
                    case "ignatardeficit":
                    {
                        Subject.Reply(source, $"{FauxItem.Template.Name} requires 15 Essence of Ignatar.", "enchantingbook");
                    ...
                    case "ignatardominance":
                    {
                        Subject.Reply(source, $"{FauxItem.Template.Name} requires 10 Essence of Ignatar.", "enchantingbook");
                    ...
                    case "miraelisbrace":
                    {
                        Subject.Reply(source, $"{FauxItem.Template.Name} requires 10 Essence of Miraelis.", "enchantingbook");
                    ...
                    case "miraelisroots":
                    {
                        Subject.Reply(source, $"{FauxItem.Template.Name} requires 15 Essence of Miraelis.", "enchantingbook");
                    ...
                    case "skandaraoffense":
                    {
                        Subject.Reply(source, $"{FauxItem.Template.Name} requires 15 Essence of Skandara.", "enchantingbook");
                    ...
                    case "theselenesorrow":
                    {
                        Subject.Reply(source, $"{FauxItem.Template.Name} requires 15 Essence of Theselene.", "enchantingbook");
                    ...
                    case "zephyrapower":
                    {
                        Subject.Reply(source, $"{FauxItem.Template.Name} requires 15 Essence of Zephyra.", "enchantingbook");
