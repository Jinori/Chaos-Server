...
public class LearnSkillScript : DialogScriptBase
{
    ...
    private readonly Dictionary<string, List<string>> PureAbilities = new()
    {
        ...
        {
            "dragonstrike", new List<string>
            {
                "dragonstrike"
            }
        },
        {
            "chaosfist", new List<string>
            {
                "chaosfist"
            }
        },
        {
            "madsoul", new List<string>
            {
                "madsoul"
            }
        },
        {
            "onslaught", new List<string>
            {
                "onslaught"
            }
        },
        {
            "sneakattack", new List<string>
            {
                "sneakattack"
            }
        },
        {
            "battlefieldsweep", new List<string>
            {
                "battlefieldsweep"
            }
        },
    ...
    private readonly Dictionary<string, List<string>> SkillUpgrades = new()
    {
        ...
        {
            "highkick", new List<string>
            {
                "mantiskick"
            }
        },
        {
            "eaglestrike", new List<string>
            {
                "phoenixstrike",
                "dragonstrike"
            }
        ...
        {
            "phoenixstrike", new List<string>
            {
                "dragonstrike"
            }
        },
        {
            "clawfist", new List<string>
            {
                "chaosfist"
            }
        },
        ...
        {
            "barrage", new List<string>
            {
                "midnightslash"
            }
        },
        {
            "throwsmokebomb", new List<string>
            {
                "smokescreen"
            }
        },
    ...
    private void HandleInvalidLearningAttempt(
        Dialog dialog,
        Aisling source,
        Skill skillToLearn,
        string reason)
    ...
    private bool IsPureMaster(Aisling source) => source.Legend.ContainsKey("dedicated");
    ...
    private void OnDisplayingAccepted(Aisling source)
    {
        ...
        switch (learnSkillResult)
        {
            case ComplexActionHelper.LearnSkillResult.Success:
                ...
                if (skillToLearn.Template.TemplateKey.Equals("summonpet", StringComparison.CurrentCultureIgnoreCase)
                    && !source.Inventory.ContainsByTemplateKey("petcollar")
                    && !source.Bank.Contains("Pet Collar"))
                {
    ...
    public bool ValidateAndTakeRequirements(Aisling source, Dialog dialog, Skill skillToLearn)
    {
        ...
        if (template.Class.HasValue && !source.HasClass(template.Class.Value))
        {
            ...
            HandleInvalidLearningAttempt(
                ...
                source,
                skillToLearn,
                "not the correct class (possibly packeting)");
        ...
        if (!ValidateRequiredStats(source, dialog, requirements)
            || !ValidatePrerequisiteSkills(source, dialog, requirements)
            || !ValidatePrerequisiteSpells(source, dialog, requirements)
            || !ValidateAndTakeItemAndGoldRequirements(source, dialog, requirements))
            return false;
