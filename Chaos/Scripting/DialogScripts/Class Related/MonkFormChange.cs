...
public class MonkFormChange : DialogScriptBase
{
    ...
    {
        {
            MonkElementForm.Water, new Animation
            {
                TargetAnimation = 67,
                AnimationSpeed = 100
            }
        ...
        {
            MonkElementForm.Fire, new Animation
            {
                TargetAnimation = 102,
                AnimationSpeed = 100
            }
        ...
        {
            MonkElementForm.Air, new Animation
            {
                TargetAnimation = 156,
                AnimationSpeed = 100
            }
        ...
        {
            MonkElementForm.Earth, new Animation
            {
                TargetAnimation = 87,
                AnimationSpeed = 100
            }
    ...
    {
        {
            MonkElementForm.Air, new HashSet<string>(StringComparer.OrdinalIgnoreCase)
            {
                "airpunch",
                "tempestkick"
            }
        ...
        {
            MonkElementForm.Fire, new HashSet<string>(StringComparer.OrdinalIgnoreCase)
            {
                "firepunch",
                "dracotailkick"
            }
        ...
        {
            MonkElementForm.Earth, new HashSet<string>(StringComparer.OrdinalIgnoreCase)
            {
                "earthpunch",
                "seismickick"
            }
        ...
        {
            MonkElementForm.Water, new HashSet<string>(StringComparer.OrdinalIgnoreCase)
            {
                "waterpunch",
                "tsunamikick"
            }
