...
public class MagicalEssenceScrapScript : DialogScriptBase
{
    ...
    public MagicalEssenceScrapScript(Dialog subject, IItemFactory itemFactory)
        : base(subject)
    {
        ItemFactory = itemFactory;

        var requestInputText = DialogString.From(
            () => $"How many {Ask!.DisplayName} would you like to turn into magical essence? You have {Ask!.Count}.");
