...
public class ArmorsmithingKitDialogScript : DialogScriptBase
{
    ...
    public ArmorsmithingKitDialogScript(Dialog subject, IItemFactory itemFactory,
        ...
        var ani = new Animation
    {
        ...
        var masterarmor = source.Inventory.FirstOrDefault(item =>
            armorRefining.ContainsKey(item.Template.TemplateKey.ToLower()));
