...
public class ForagingEffect(IItemFactory itemFactory, ILogger<ForagingEffect> logger) : ContinuousAnimationEffectBase
{
    ...
    {
        new KeyValuePair<string, decimal>("greengrapes", 8),
        new KeyValuePair<string, decimal>("strawberry", 8),
        new KeyValuePair<string, decimal>("tangerines", 8),
        new KeyValuePair<string, decimal>("rambutan", 5),
        new KeyValuePair<string, decimal>("tomato", 10),
        new KeyValuePair<string, decimal>("petunia", 4),
        new KeyValuePair<string, decimal>("pinkrose", 4),
        new KeyValuePair<string, decimal>("waterlily", 4),
        new KeyValuePair<string, decimal>("blossomofbetrayal", 1),
        new KeyValuePair<string, decimal>("bocanbough", 2),
        new KeyValuePair<string, decimal>("cactusflower", 2),
        new KeyValuePair<string, decimal>("dochasbloom", 2),
        new KeyValuePair<string, decimal>("lilypad", 2),
        new KeyValuePair<string, decimal>("koboldtail", 3),
        new KeyValuePair<string, decimal>("kabineblossom", 3),
        new KeyValuePair<string, decimal>("passionflower", 3),
        new KeyValuePair<string, decimal>("raineach", 3),
