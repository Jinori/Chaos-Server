...
public class PotentAstralEffect : EffectBase, NonOverwritableEffectComponent.INonOverwritableEffectComponentOptions
{
    ...
    public override string Name => "Potent Astral";
    ...
    public override void OnApplied()
    {
        ...
        AislingSubject?.Client.SendServerMessage(ServerMessageType.OrangeBar1, "Maximum Mana has increased by 6,000.");
    }
