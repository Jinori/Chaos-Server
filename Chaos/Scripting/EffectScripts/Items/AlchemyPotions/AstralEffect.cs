...
public class AstralEffect : EffectBase, NonOverwritableEffectComponent.INonOverwritableEffectComponentOptions
{
    ...
    public override void OnApplied()
    {
        ...
        AislingSubject?.Client.SendServerMessage(ServerMessageType.OrangeBar1, "Maximum Mana has increased by 800.");
    }
