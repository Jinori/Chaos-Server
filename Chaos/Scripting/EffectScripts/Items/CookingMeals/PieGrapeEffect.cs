...
public class PieGrapeEffect : EffectBase, NonOverwritableEffectComponent.INonOverwritableEffectComponentOptions
{
    ...
    public override string Name => "Pie Grape";
    ...
    public override void OnApplied()
    {
        ...
        AislingSubject?.Client.SendServerMessage(ServerMessageType.OrangeBar1, "You feel your magic damage increase.");
    }
