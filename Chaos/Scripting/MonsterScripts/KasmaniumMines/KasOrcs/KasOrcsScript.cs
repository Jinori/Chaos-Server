...
public class KasOrcsScript : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        GetScriptKey(typeof(DefaultBehaviorsScript)),
        GetScriptKey(typeof(MoveToTargetScript)),
        GetScriptKey(typeof(KasOrcsEnrageScript)),
    ...
    /// <inheritdoc />
    public KasOrcsScript(IScriptProvider scriptProvider, Monster subject)
    {
