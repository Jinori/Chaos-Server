...
public sealed class RandomSkillScript : MonsterScriptBase
{
    ...
    [
        "beagsuain", "shockwave", "sapNeedle", "devour", "clawfist", "madsoul", "ambush", "multistrike", "crasher", "assassinstrike", "frostbomb", "dracotailkick", "seismickick"
    ];
    /// <inheritdoc />
    ...
    private static IEnumerable<string> PickRandomSkills(string[] allSkills, int numberOfSkills) => AllSkills.OrderBy(_ => Guid.NewGuid()).Take(numberOfSkills);
}