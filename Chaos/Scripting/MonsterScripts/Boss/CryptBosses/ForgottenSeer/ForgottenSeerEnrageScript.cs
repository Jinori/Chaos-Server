...
public sealed class ForgottenSeerEnrageScript : MonsterScriptBase
{
    ...
    /// <inheritdoc />
    public ForgottenSeerEnrageScript(Monster subject, IMonsterFactory monsterFactory)
        : base(subject) =>
    ...
    public override void Update(TimeSpan delta)
    {
        if (!Bonus75Applied && (Subject.StatSheet.HealthPercent <= 75))
        {
            ...
            for (var i = 0; i <= 16; i++)
            {
                ...
                var mobs = MonsterFactory.Create("deepcrypt_rat2", Subject.MapInstance, point);
        ...
        if (!Bonus30Applied && (Subject.StatSheet.HealthPercent <= 30))
        {
            ...
            for (var i = 0; i <= 5; i++)
            {
                ...
                var mobs = MonsterFactory.Create("deepcrypt_succubus2", Subject.MapInstance, point);
                Subject.MapInstance.AddEntity(mobs, point);
            }
