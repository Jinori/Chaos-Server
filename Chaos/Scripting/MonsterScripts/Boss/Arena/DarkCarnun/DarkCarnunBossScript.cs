...
public class DarkCarnunBossScript : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        GetScriptKey(typeof(DefaultBehaviorsScript)),
        GetScriptKey(typeof(BossMoveToTargetScript)),
        GetScriptKey(typeof(DarkCarnunEnrageScript)),
    ...
    /// <inheritdoc />
    public DarkCarnunBossScript(IScriptProvider scriptProvider, Monster subject)
    {
