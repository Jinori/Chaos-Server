...
public sealed class DarkCarnunEnrageScript : MonsterScriptBase
{
    ...
    /// <inheritdoc />
    public DarkCarnunEnrageScript(Monster subject, IMonsterFactory monsterFactory)
        : base(subject) =>
    ...
    public override void Update(TimeSpan delta)
    {
        if (!Bonus75Applied && (Subject.StatSheet.HealthPercent <= 75))
        {
            ...
            for (var i = 0; i <= 1; i++)
            {
                ...
                var mobs1 = MonsterFactory.Create("arenarogue71", Subject.MapInstance, point);
                var mobs2 = MonsterFactory.Create("arenawizard71", Subject.MapInstance, point);
                var mobs3 = MonsterFactory.Create("arenamonk71", Subject.MapInstance, point);
