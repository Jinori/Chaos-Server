...
public class GrimlockBoss3Script : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        ...
        GetScriptKey(typeof(GrimlockBoss3EnrageScript)),
    ...
    /// <inheritdoc />
    public GrimlockBoss3Script(IScriptProvider scriptProvider, Monster subject)
    {
