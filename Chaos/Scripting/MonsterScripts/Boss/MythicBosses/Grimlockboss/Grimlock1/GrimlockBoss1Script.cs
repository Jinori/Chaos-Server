...
public class GrimlockBoss1Script : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        ...
        GetScriptKey(typeof(GrimlockBoss1EnrageScript)),
    ...
    /// <inheritdoc />
    public GrimlockBoss1Script(IScriptProvider scriptProvider, Monster subject)
    {
