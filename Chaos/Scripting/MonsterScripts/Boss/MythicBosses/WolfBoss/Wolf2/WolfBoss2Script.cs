...
public class WolfBoss2Script : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        ...
        GetScriptKey(typeof(WolfBoss2EnrageScript)),
    ...
    /// <inheritdoc />
    public WolfBoss2Script(IScriptProvider scriptProvider, Monster subject)
    {
