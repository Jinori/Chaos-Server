...
public class WolfBoss1Script : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        ...
        GetScriptKey(typeof(WolfBoss1EnrageScript)),
    ...
    /// <inheritdoc />
    public WolfBoss1Script(IScriptProvider scriptProvider, Monster subject)
    {
