...
public sealed class Gargoyle2BossThrowHazardousScript : MonsterScriptBase
{
    ...
    /// <inheritdoc />
    public Gargoyle2BossThrowHazardousScript(Monster subject)
        : base(subject)
    {
    ...
    public override void Update(TimeSpan delta)
    {
        ...
        if (target != null)
        {
            ...
            {
                var damage = (int)(aisling.StatSheet.EffectiveMaximumHp * 0.5);
