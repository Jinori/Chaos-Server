...
public sealed class Gargoyle3BossThrowHazardousScript : MonsterScriptBase
{
    ...
    /// <inheritdoc />
    public Gargoyle3BossThrowHazardousScript(Monster subject)
        : base(subject)
    {
    ...
    public override void Update(TimeSpan delta)
    {
        ...
        if (target != null)
        {
            ...
            {
                var damage = (int)(aisling.StatSheet.EffectiveMaximumHp * 0.6);
