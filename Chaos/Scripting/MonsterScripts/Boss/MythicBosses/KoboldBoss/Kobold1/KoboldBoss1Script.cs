...
public class KoboldBoss1Script : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        ...
        GetScriptKey(typeof(KoboldBoss1EnrageScript)),
    ...
    /// <inheritdoc />
    public KoboldBoss1Script(IScriptProvider scriptProvider, Monster subject)
    {
