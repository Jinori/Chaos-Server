...
public class TwinkBossScript : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        ...
        GetScriptKey(typeof(TwinkBossEnrageScript)),
    ...
    /// <inheritdoc />
    public TwinkBossScript(IScriptProvider scriptProvider, Monster subject)
    {
