...
public sealed class FireDracoBossEnrageScript : MonsterScriptBase
{
    ...
    /// <inheritdoc />
    public FireDracoBossEnrageScript(Monster subject, IMonsterFactory monsterFactory)
        : base(subject) =>
    ...
    public override void Update(TimeSpan delta)
    {
        ...
        if (!Bonus50Applied && (Subject.StatSheet.HealthPercent <= 50))
        {
            ...
            for (var i = 0; i <= 3; i++)
            {
                ...
                var mobs = MonsterFactory.Create("LW_Wisp", Subject.MapInstance, point);
        ...
        if (!Bonus30Applied && (Subject.StatSheet.HealthPercent <= 30))
        {
            ...
            for (var i = 0; i <= 4; i++)
            {
                ...
                var mobs = MonsterFactory.Create("LW_Faerie", Subject.MapInstance, point);
                Subject.MapInstance.AddEntity(mobs, point);
            }
