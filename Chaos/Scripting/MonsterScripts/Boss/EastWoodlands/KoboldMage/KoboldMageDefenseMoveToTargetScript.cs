...
public class KoboldMageDefenseMoveToTargetScript : MonsterScriptBase
{
    /// <inheritdoc />
    public KoboldMageDefenseMoveToTargetScript(Monster subject)
        : base(subject) { }
    ...
    public override void Update(TimeSpan delta)
    {
        ...
        if (Subject.Template.TemplateKey.Contains("EW_koboldMage"))
        {
            if (distance <= 3)
            {
