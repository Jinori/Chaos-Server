...
public sealed class SoulCollectorEnrageScript : MonsterScriptBase
{
    ...
    /// <inheritdoc />
    public SoulCollectorEnrageScript(Monster subject, IMonsterFactory monsterFactory)
        : base(subject) =>
    ...
    public override void Update(TimeSpan delta)
    {
        if (!Bonus75Applied && (Subject.StatSheet.HealthPercent <= 75))
        {
            ...
            for (var i = 0; i <= 2; i++)
            {
                ...
                var mobs = MonsterFactory.Create("mummy10", Subject.MapInstance, point);
