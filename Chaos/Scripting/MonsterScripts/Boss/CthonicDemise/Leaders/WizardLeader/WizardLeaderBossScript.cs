...
public class WizardLeaderBossScript : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        GetScriptKey(typeof(DefaultBehaviorsScript)),
        GetScriptKey(typeof(WizardLeaderDefenseMoveToTargetScript)),
        GetScriptKey(typeof(PriestEnrageSummonScript)),
    ...
    /// <inheritdoc />
    public WizardLeaderBossScript(IScriptProvider scriptProvider, Monster subject)
    {
