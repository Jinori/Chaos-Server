...
namespace Chaos.Scripting.MonsterScripts.Boss.EventBoss.ForsakenRogue;

public class ForsakenRogueScript : CompositeMonsterScript
{
    ...
    /// <inheritdoc />
    public ForsakenRogueScript(IScriptProvider scriptProvider, Monster subject)
    {
