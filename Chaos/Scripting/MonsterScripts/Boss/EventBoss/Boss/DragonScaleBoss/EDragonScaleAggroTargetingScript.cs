...
public class EDragonScaleAggroTargetingScript : MonsterScriptBase
{
    private readonly IIntervalTimer TargetUpdateTimer;
    private int InitialAggro = 10;

    /// <inheritdoc />
    public EDragonScaleAggroTargetingScript(Monster subject)
        : base(subject)
    ...
    public override void Update(TimeSpan delta)
    {
        ...
        if ((Target != null) && (!Target.IsAlive || !Target.OnSameMapAs(Subject) || Target.MapInstance.IsWalkable(Target, collisionType: CreatureType.Normal)))
        {
