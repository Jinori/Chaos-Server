...
using Chaos.Scripting.MonsterScripts.Boss.DragonScaleBoss;

namespace Chaos.Scripting.MonsterScripts.Boss.EventBoss.Boss.DragonScaleBoss;

public class EdragonScaleBossScript : CompositeMonsterScript
{
    ...
    /// <inheritdoc />
    public EdragonScaleBossScript(IScriptProvider scriptProvider, Monster subject)
    {
