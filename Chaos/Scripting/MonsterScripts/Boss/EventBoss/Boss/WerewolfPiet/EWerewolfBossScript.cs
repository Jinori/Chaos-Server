...
using Chaos.Scripting.MonsterScripts.Boss.WerewolfPiet;

namespace Chaos.Scripting.MonsterScripts.Boss.EventBoss.Boss.WerewolfPiet;

public class EWerewolfBossScript : CompositeMonsterScript
{
    ...
    /// <inheritdoc />
    public EWerewolfBossScript(IScriptProvider scriptProvider, Monster subject)
    {
