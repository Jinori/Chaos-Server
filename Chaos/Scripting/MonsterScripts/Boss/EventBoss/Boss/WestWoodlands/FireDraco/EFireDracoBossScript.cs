...
public class EFireDracoBossScript : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        ...
        GetScriptKey(typeof(EFireDracoBossEnrageScript)),
    ...
    /// <inheritdoc />
    public EFireDracoBossScript(IScriptProvider scriptProvider, Monster subject)
    {
