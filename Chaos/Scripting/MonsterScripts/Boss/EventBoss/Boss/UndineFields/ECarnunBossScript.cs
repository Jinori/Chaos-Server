...
public class ECarnunBossScript : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        ...
        GetScriptKey(typeof(ECarnunBossRoomHazardScript)),
    ...
    /// <inheritdoc />
    public ECarnunBossScript(IScriptProvider scriptProvider, Monster subject)
    {
