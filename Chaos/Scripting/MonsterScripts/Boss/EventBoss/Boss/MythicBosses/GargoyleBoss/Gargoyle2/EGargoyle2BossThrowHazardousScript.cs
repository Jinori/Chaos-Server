...
public sealed class EGargoyle2BossThrowHazardousScript : MonsterScriptBase
{
    ...
    /// <inheritdoc />
    public EGargoyle2BossThrowHazardousScript(Monster subject)
        : base(subject)
    {
    ...
    public override void Update(TimeSpan delta)
    {
        ...
        if (target != null)
        {
            ...
            {
                var damage = (int)(aisling.StatSheet.EffectiveMaximumHp * 0.12);
