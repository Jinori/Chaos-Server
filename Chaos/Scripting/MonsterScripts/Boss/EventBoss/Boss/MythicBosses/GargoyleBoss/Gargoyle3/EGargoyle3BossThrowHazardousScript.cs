...
public sealed class EGargoyle3BossThrowHazardousScript : MonsterScriptBase
{
    ...
    /// <inheritdoc />
    public EGargoyle3BossThrowHazardousScript(Monster subject)
        : base(subject)
    {
    ...
    public override void Update(TimeSpan delta)
    {
        ...
        if (target != null)
        {
            ...
            {
                var damage = (int)(aisling.StatSheet.EffectiveMaximumHp * 0.15);
