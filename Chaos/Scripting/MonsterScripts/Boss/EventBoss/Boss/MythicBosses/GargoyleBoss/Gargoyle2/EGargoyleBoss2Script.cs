...
using Chaos.Scripting.MonsterScripts.Boss.MythicBosses.GargoyleBoss.Gargoyle2;

namespace Chaos.Scripting.MonsterScripts.Boss.EventBoss.Boss.MythicBosses.GargoyleBoss.Gargoyle2;

public class EGargoyleBoss2Script : CompositeMonsterScript
{
    ...
    /// <inheritdoc />
    public EGargoyleBoss2Script(IScriptProvider scriptProvider, Monster subject)
    {
