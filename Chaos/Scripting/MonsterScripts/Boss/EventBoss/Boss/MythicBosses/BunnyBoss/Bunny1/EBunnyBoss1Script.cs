...
namespace Chaos.Scripting.MonsterScripts.Boss.EventBoss.Boss.MythicBosses.BunnyBoss.Bunny1;

public class EBunnyBoss1Script : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        ...
        GetScriptKey(typeof(EBunnyBoss1EnrageScript)),
    ...
    /// <inheritdoc />
    public EBunnyBoss1Script(IScriptProvider scriptProvider, Monster subject)
    {
