...
namespace Chaos.Scripting.MonsterScripts.Boss.EventBoss.Boss.PentagramBoss;

public class EPentagramBossScript : CompositeMonsterScript
{
    ...
    /// <inheritdoc />
    public EPentagramBossScript(IScriptProvider scriptProvider, Monster subject)
    {
