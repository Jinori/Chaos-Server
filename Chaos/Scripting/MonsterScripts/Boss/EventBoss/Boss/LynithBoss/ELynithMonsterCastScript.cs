...
public sealed class ELynithMonsterCastScript : MonsterScriptBase
{
    ...
    /// <inheritdoc />
    public ELynithMonsterCastScript(Monster subject, ISpellFactory spellFactory)
        : base(subject)
    {
        SpellToCast = spellFactory.Create("diacradh");
