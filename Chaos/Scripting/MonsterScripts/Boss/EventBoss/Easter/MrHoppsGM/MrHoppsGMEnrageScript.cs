...
namespace Chaos.Scripting.MonsterScripts.Boss.EventBoss.Easter.MrHoppsGM;

public sealed class MrHoppsGMEnrageScript : MonsterScriptBase
{
        ...
        : base(subject)
    {
        ...
        SpellToCast = SpellFactory.Create("bunnypounceGM");
        SpellToCast2 = SpellFactory.Create("bunnyseismicshiftGM");
        SpellToCast3 = SpellFactory.Create("bunnychainlightningGM");
        ...
        if (RandomAbilityTimer.IntervalElapsed)
        {
            ...
            if (random < 50)
            {
                ...
                while (mobsSpawned < 5)
                    ...
                    {
                        var mob = MonsterFactory.Create("fieldfloppygm", Subject.MapInstance, point);
