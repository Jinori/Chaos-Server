...
namespace Chaos.Scripting.MonsterScripts.Boss.EventBoss.Easter.MrHoppsMaster;

public sealed class MrHoppsMasterEnrageScript : MonsterScriptBase
{
    ...
    /// <inheritdoc />
    public MrHoppsMasterEnrageScript(
        Monster subject,
        ...
        : base(subject)
    {
        ...
        SpellToCast = SpellFactory.Create("bunnypounceMaster");
        SpellToCast2 = SpellFactory.Create("bunnyseismicshiftMaster");
        SpellToCast3 = SpellFactory.Create("bunnychainlightningMaster");
    ...
    private void RegenerateFromBats()
    {
        ...
        if (amountFloppies > 0)
        {
            var healamt = amountFloppies * 0.002;
        ...
        if (RandomAbilityTimer.IntervalElapsed)
        {
            ...
            if (random < 50)
            {
                ...
                while (mobsSpawned < 5)
                    ...
                    {
                        var mob = MonsterFactory.Create("fieldfloppymaster", Subject.MapInstance, point);
