...
public class MtMerryBoss80 : CompositeMonsterScript
{
    private static readonly ICollection<string> ScriptKeys = new[]
    {
        GetScriptKey(typeof(DefaultBehaviorsScript)),
        GetScriptKey(typeof(MoveToTargetScript)),
        GetScriptKey(typeof(MtMerry80BossEnrageScript)),
    ...
    /// <inheritdoc />
    public MtMerryBoss80(IScriptProvider scriptProvider, Monster subject)
    {
