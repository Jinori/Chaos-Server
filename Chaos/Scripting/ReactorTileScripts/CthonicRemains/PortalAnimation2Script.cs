...
public class PortalAnimation2Script : ReactorTileScriptBase
{
    ...
    /// <inheritdoc />
    public PortalAnimation2Script(ReactorTile subject)
        : base(subject)
    {
        AnimationTimer = new IntervalTimer(TimeSpan.FromSeconds(1), false);
        Timer = new IntervalTimer(TimeSpan.FromSeconds(8), false);
    }
