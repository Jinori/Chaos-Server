...
public class CasinoMonsterRaceLaneLavaScript : ReactorTileScriptBase
{
    ...
    private readonly ILogger<CasinoMonsterRaceLaneLavaScript> Logger;
    ...
    /// <inheritdoc />
    public CasinoMonsterRaceLaneLavaScript(ReactorTile subject, ILogger<CasinoMonsterRaceLaneLavaScript> logger)
        : base(subject)
    {
        Logger = logger;
    ...
    public override void OnWalkedOn(Creature source)
    {
        ...
        foreach (var aisling in AislingsAtCompletion)
            if (aisling.MonsterRacingLane is "Lava")
        ...
        switch (AislingsThatWon.Count)
        {
            ...
            {
                foreach (var aisling in AislingsAtCompletion)
                    aisling.SendActiveMessage("Lane Lava won! Nobody picked Lane Lava!");
