...
public class CasinoMonsterRaceLaneGrassScript : ReactorTileScriptBase
{
    private readonly IIntervalTimer AfterWinnerDelay;
    private readonly List<Aisling> AislingsThatWon = new();
    private readonly ILogger<CasinoMonsterRaceLaneGrassScript> Logger;
    ...
    /// <inheritdoc />
    public CasinoMonsterRaceLaneGrassScript(ReactorTile subject, ILogger<CasinoMonsterRaceLaneGrassScript> logger)
        : base(subject)
    {
        Logger = logger;
    ...
    public override void OnWalkedOn(Creature source)
    {
        ...
        foreach (var aisling in AislingsAtCompletion)
            if (aisling.MonsterRacingLane is "Grass")
        ...
        switch (AislingsThatWon.Count)
        {
            ...
            {
                foreach (var aisling in AislingsAtCompletion)
                    aisling.SendActiveMessage("Lane Grass won! Nobody picked Lane Grass!");
