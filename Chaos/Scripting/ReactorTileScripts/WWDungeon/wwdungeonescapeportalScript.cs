...
namespace Chaos.Scripting.ReactorTileScripts.WWDungeon;

public class WwdungeonescapeportalScript : ReactorTileScriptBase
{
    ...
    /// <inheritdoc />
    public WwdungeonescapeportalScript(ReactorTile subject, ISimpleCache simpleCache)
        : base(subject)
    {
    ...
    public override void OnWalkedOn(Creature source)
    {
        ...
        var targetMap = SimpleCache.Get<MapInstance>("west_woodlandsEntrance");
        var rectangle = new Rectangle(4, 13, 3, 3);
