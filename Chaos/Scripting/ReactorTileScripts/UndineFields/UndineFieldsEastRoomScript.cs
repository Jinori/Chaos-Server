...
public class UndineFieldsEastRoomScript : ReactorTileScriptBase
{
    ...
    /// <inheritdoc />
    public UndineFieldsEastRoomScript(ReactorTile subject, IItemFactory itemFactory, IDialogFactory dialogFactory, ISimpleCache simpleCache, IMerchantFactory merchantFactory)
        : base(subject)
    {
    ...
    public override void OnWalkedOn(Creature source)
    {
        ...
        if (allMembersHaveQuestEnum)
        {
            ...
            var merchant = MerchantFactory.Create("uf_entrance_merchant", aisling.MapInstance, npcpoint);
                ...
                var dialog = DialogFactory.Create("uf_entrancenorth2", merchant);
