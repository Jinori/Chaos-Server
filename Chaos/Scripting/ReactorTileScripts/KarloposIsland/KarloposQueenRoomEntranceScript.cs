...
public class KarloposQueenRoomEntranceScript : ConfigurableReactorTileScriptBase
{
    ...
    /// <inheritdoc />
    public KarloposQueenRoomEntranceScript(ReactorTile subject, ISimpleCache simpleCache)
        : base(subject) =>
    ...
    public override void OnWalkedOn(Creature source)
    {
        ...
        if ((aisling != null)
            ...
            aisling?.SendOrangeBarMessage("You see something in the distance.");
    }
}