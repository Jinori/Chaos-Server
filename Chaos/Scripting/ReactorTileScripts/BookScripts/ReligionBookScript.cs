...
public sealed class ReligionBookScript : ReactorTileScriptBase
{
    /// <inheritdoc />
    public ReligionBookScript(ReactorTile subject)
        : base(subject) {}
