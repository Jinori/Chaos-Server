...
public class MasterCheckWarpScript : ConfigurableReactorTileScriptBase
{
    ...
    /// <inheritdoc />
    public MasterCheckWarpScript(ReactorTile subject, ISimpleCache simpleCache)
        : base(subject)
    ...
    public override void OnWalkedOn(Creature source)
    {
        ...
        {
            aisling.SendOrangeBarMessage("You peer into the next room afraid for your life.");
