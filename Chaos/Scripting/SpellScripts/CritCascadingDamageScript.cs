...
public class CritCascadingDamageScript : ConfigurableSpellScriptBase,
...
{
    /// <inheritdoc />
    public CritCascadingDamageScript(Spell subject, IReactorTileFactory reactorTileFactory)
        : base(subject)
    {
