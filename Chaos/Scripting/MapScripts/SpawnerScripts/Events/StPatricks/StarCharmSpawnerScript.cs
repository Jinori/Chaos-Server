...
public class StarCharmSpawnerScript : ItemSpawnerScript
{
    ...
    public override string ItemTemplateKey { get; set; } = "starcharm";
    ...
    /// <inheritdoc />
    public StarCharmSpawnerScript(MapInstance subject, IItemFactory itemFactory, ISimpleCache simpleCache)
