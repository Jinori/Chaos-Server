...
public class HorseshoeCharmSpawnerScript : ItemSpawnerScript
{
    public override string ItemTemplateKey { get; set; } = "horseshoecharm";
    ...
    /// <inheritdoc />
    public HorseshoeCharmSpawnerScript(MapInstance subject, IItemFactory itemFactory, ISimpleCache simpleCache)
