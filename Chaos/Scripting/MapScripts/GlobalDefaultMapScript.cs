...
{
    private static readonly FrozenSet<ushort> HEMP_TILE_IDS = new ushort[]
    {
        755,
        756
    }.ToFrozenSet();
    ...
    public GlobalDefaultMapScript(MapInstance subject, IReactorTileFactory reactorTileFactory)
        : base(subject)
    {
