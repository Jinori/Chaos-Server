...
public class FemalePriestNightmareChallengeMapScript : MapScriptBase
{
    ...
    public FemalePriestNightmareChallengeMapScript(
        MapInstance subject,
    ...
    private void SpawnMonsters()
    {
        ...
        for (var i = 0; i < 5; i++)
        {
            ...
            var monster = MonsterFactory.Create("nightmare_magda", Subject, point);
