...
public class MalePriestNightmareChallengeMapScript : MapScriptBase
{
    ...
    private void SpawnMonsters()
    {
        ...
        for (var i = 0; i < 4; i++)
        {
            ...
            var monster = MonsterFactory.Create("nightmare_cthonic", Subject, point);
    ...
    private void SpawnTeam()
    {
        ...
        var target = Subject.GetEntities<Aisling>()
                            .Single();
        ...
        if (Subject.GetEntities<Aisling>()
                   .Any(a => a.Gender == Gender.Male))
        {
            var monster1 = MonsterFactory.Create("nightmare_malewarrior", Subject, point1);

            var monster2 = MonsterFactory.Create("nightmare_malemonk", Subject, point2);

            var monster3 = MonsterFactory.Create("nightmare_malerogue", Subject, point3);

            var monster4 = MonsterFactory.Create("nightmare_malewizard", Subject, point4);
        ...
        {
            var monster1 = MonsterFactory.Create("nightmare_femalewarrior", Subject, point1);

            var monster2 = MonsterFactory.Create("nightmare_femalemonk", Subject, point2);

            var monster3 = MonsterFactory.Create("nightmare_femalerogue", Subject, point3);

            var monster4 = MonsterFactory.Create("nightmare_femalewizard", Subject, point4);
