...
public class WarriorNightmareChallengeMapScript : MapScriptBase
{
    ...
    private void SpawnMonsters()
    {
        ...
        var monster = MonsterFactory.Create("nightmare_carnun", Subject, point);
            ...
            switch (State)
            {
                ...
                case ScriptState.DelayedStart:
                    ...
                    if ((DateTime.UtcNow - StartTime) > StartDelay)
                    {
                        ...
                        foreach (var aisling in Subject.GetEntities<Aisling>())
                            ...
                            aisling.Client.SendServerMessage(ServerMessageType.OrangeBar1, "Fight the Carnun to the death.");
                    }
                ...
                case ScriptState.Spawned:
                {
                    ...
                    if (PriestDelay!.IntervalElapsed)
                    {
                        ...
                        var priest = MerchantFactory.Create("nightmare_priestsupport", Subject, point);
