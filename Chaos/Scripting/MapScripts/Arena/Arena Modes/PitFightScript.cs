...
/// <summary>
///     Script to manage the pit fight arena mode. Handles player victories, losses, and missing players.
/// </summary>
public class PitFightScript : MapScriptBase
{
    ...
    public PitFightScript(
        ...
        IStorage<PitFightLeaderboardScript.PitFightLeaderboardObj> leaderboardStorage,
    ...
    private void AwardWin(Aisling winner, Aisling loser)
    {
        ...
        foreach (var client in ClientRegistry)
            client.SendServerMessage(ServerMessageType.OrangeBar1, $"{loser.Name} was humiliated by {winner.Name} in a Pit Fight!");
    ...
    private void HandleMissingPlayerCheck(TimeSpan delta)
    {
                ...
                .Equals(PlayerStillActive))
        {
            ...
            foreach (var client in ClientRegistry)
                client.SendServerMessage(ServerMessageType.OrangeBar1, $"{PlayerStillActive.Name} wins the Pit Fight by forfeit!");
    ...
    private void RevivePlayers(List<Aisling> players)
    {
        ...
        for (var i = 0; i < players.Count; i++)
        {
            ...
            players[i]
                .TraverseMap(Subject, revivePositions[i]);

            players[i]
                .SendMessage("You have been revived and repositioned to continue fighting!");
        }
    }
